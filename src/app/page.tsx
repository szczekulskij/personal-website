        ...
        <div className="flex flex-col sm:flex-row gap-8 items-start">
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-text leading-tight mb-4">
              Hey, I&apos;m Jan. I build software and research AI.
            </h1>
            <p className="text-text text-sm leading-relaxed mb-3">
              Currently pursuing my Masters in CSE at{' '}
              <a href="https://ucsd.edu" className="text-accent hover:text-accent-hover underline underline-offset-2">UCSD</a>,
              working in the Contextual Robotics Institute. Before that, I was a Software Engineer at{' '}
            ...
            <p className="text-text text-sm leading-relaxed mb-5">
              I also collaborate with Lazarski University on AI applications in Medicine,
              using GANs for PWS birthmark treatment prediction.
            </p>
            <div className="flex items-center gap-4 text-[10px] font-mono tracking-widest text-text-muted">
              ...
              <a href="https://www.researchgate.net/profile/Jan-Szczekulski" target="_blank" rel="noopener noreferrer" className="hover:text-text transition-colors">
                RESEARCHGATE
              </a>
            </div>
          </div>
          ...
          <div className="shrink-0">
            <div className="w-36 h-44 bg-bg-card border border-border rounded overflow-hidden shadow-sm">
